...
module.exports = {
  ...
  rules: {
    ...
    'curlyplus/curlyplus': ['off', 'multi-or-nest'],
    'default-case': 'error',
    ...
    'filenames/match-regex': [1, '^(\\.[a-zA-Z0-9_]+(\\.[a-z]+)?|index)$', true],
    ...
    'header/header': [2, 'line', {pattern: '[A-Za-z0-9@*]*'}],
    'id-blacklist': 'error',
    'id-length': 'off',
    'id-match': 'error',
    ...
    'padding-line-between-statements': [
      ...
      {blankLine: 'any', prev: 'multiline-const', next: 'multiline-const'},
